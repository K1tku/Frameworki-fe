        ...
        <Wrapper>
            <Top>
                <Photo style={{borderRadius:'5px'}}>
                    <img style={{borderTopRightRadius:'5px', borderTopLeftRadius:'5px'}} src = {groupnorms} alt = {groupnorms}/>

                </Photo>

                <Text>
                    <img style={{height:'50px', marginLeft:'20px', marginTop:'20px'}} src = {entities} alt = {entities}/>
                    <a style={{fontSize:'25px',position:'absolute', marginTop:'10px', marginLeft:'20px'}}>Group Norms</a>
