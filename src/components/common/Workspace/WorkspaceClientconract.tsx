...
import clientconract from "../../../media/photos/clientconract.jpg";
...
export const WorkspaceClientconract: FC = () => {
    return (
        <Wrapper>
            <Top>
                ...
                <Text>
                    ...
                    <a style={{fontSize:'25px',position:'absolute', marginTop:'10px', marginLeft:'20px'}}>Client conract</a>
